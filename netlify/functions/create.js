...
// Tenta configuração manual (siteID + token) se as variáveis estiverem definidas;
// isso evita o erro "MissingBlobsEnvironmentError" que às vezes acontece mesmo
// com tudo certo no código, quando o Netlify não injeta o contexto automaticamente.
